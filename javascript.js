...
function growBox() {
    let boxAValue = document.getElementById('boxa').value;
    let boxBValue = document.getElementById('boxb').value;
    let boxCValue = document.getElementById('boxc').value;

    let boxA = document.getElementById('b1');
    let boxB = document.getElementById('b2');
    let boxC = document.getElementById('b3');

    boxA.style.flexGrow = `${boxAValue}`;
    boxB.style.flexGrow = `${boxBValue}`;
    boxC.style.flexGrow = `${boxCValue}`;
  }